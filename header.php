    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="" class="text-decoration-none">
                   <!-- <span class="h1 text-uppercase text-primary bg-dark px-2">Multi</span>-->
                    <span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">Veer</span>
                </a>
            </div>
            ...
            <div class="col-lg-4 col-6 text-right">
                ...
                ?>
                <div class="btn-group">
                    <a href="login.php"><button type="button" class="btn btn-md btn-outline-warning">Login</button></a>
                </div>
                <?php
                        }
                    else
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        <?php
                            ...
                            {
                        ?>
                        <a href="shop.php?sid=<?php echo $rw[0];?>" class="nav-item nav-link"><?php echo $rw[1];?></a>
                        <?php
                            }
                        ?>
                    </div>
